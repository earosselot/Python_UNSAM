...
def parse_csv(input_files, select=None, types=None, has_headers=True):
    '''
...
# with open('../Data/camion.csv', encoding='utf8') as file:
    # camion = parse_csv(file, types=[str, int, float])  # csv.reader(f)
